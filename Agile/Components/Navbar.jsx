...
function Navbar() {
  ...
  const userNavItems = (
    <>
      ...
      <li>
        <Link to="/subscription/my-subscriptions">My Subscriptions</Link>
      </li>
      <li>
        <Link to="/fruitsection">Fruits</Link>
      </li>
      <li>
        <Link to="/veggiesection">Vegetables</Link>
      </li>
      <li>
        ...
        <div className="navbar bg-base-100">
          ...
          <div className="navbar-end space-x-3">
            <div className="navbar-center hidden lg:flex">
              <ul className="menu menu-horizontal px-1">{currentNavItems}</ul>
            </div>
            <div>
