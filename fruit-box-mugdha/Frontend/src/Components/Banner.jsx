        ...
        <div className="banner-container w-full order-2 md:order-1 md:w-4/5 mt-12 md:mt-20">
          <div className="banner-content">
            ...
            <p className="banner-subtitle">
              ...
              delivered directly to you. Enjoy the convenience of supporting
              your community while indulging in a variety of handpicked,
              seasonal fruits that are sourced locally. Our service ensures you
              receive high-quality, ripe, and nutritious produce, perfect for a
              healthy lifestyle. Stay connected with your neighborhood vendors
              and experience the difference of farm-fresh fruits delivered with
              care.
            </p>
